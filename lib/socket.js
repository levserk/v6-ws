...
Socket.prototype.send = function(data){
    ...
    try{
        ...
        this.ws.send(data);
        //this.server.onMessageSend(data.length);
...
Socket.prototype.onMessage = function(data){
    ...
    try{
        //this.server.onMessageReceived(data.length);
        if (data=='pong'){
            this.onPong();
            return;
        }
        if (global.logLevel > 3) util.log('log;', 'Socket.onMessage', data);
